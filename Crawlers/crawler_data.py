...
for anchor in movies:
	...
	movie_content = movie_soup.find('div', { 'class': 'panel-body content_body'}).find('p', {'data-qa' : 'movie-info-synopsis'})
	print(num, urls, '\n', 'Movie:' + anchor.find('span',{'class':'p--small'}).string.strip())
	print('Movie info:' + movie_content.string.strip())
	table.write(line, 0, num)
	table.write(line, 1, urls)
	table.write(line, 2, anchor.find('span',{'class':'p--small'}).string.strip())
